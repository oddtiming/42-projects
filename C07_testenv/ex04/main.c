...
//	printf("atoi = %d\n", *ft_atoi_base(str16, base16, base_size(base16)));
	...
	printf("result : $%s$\n", ft_convert_base("21474689712397812387947", "0123456789", "0123456789abcdef"));
	printf("result : $%s$\n", ft_convert_base("--+-+--7fffffffffffff", "0123456789abcdef", "01"));
	printf("result : $%s$\n", ft_convert_base("00", "01345679", "0123456789"));
